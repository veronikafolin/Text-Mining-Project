...
task_to_keys = {
    "task1": ("testo_integrale", "tipologia_pronuncia"),
    "task2": ("testo_integrale", "judgement")
}
...
def main():
    ...
    # Labels
    dataset_columns = task_to_keys.get(data_args.task_name, None)
